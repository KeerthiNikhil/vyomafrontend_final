...
const Delivery = () => {
  ...
  <select
    ...
    onChange={(e) =>
      setSelectedBoy(
        deliveryBoys.find((boy) => boy.id === Number(e.target.value))
      )
    }
  >
          ...
          {selectedBoy && (
            <div className="bg-white shadow rounded-xl p-6 space-y-4">
              ...
              <div className="text-sm space-y-1">
                <p><strong>Phone:</strong> {selectedBoy.phone}</p>
                <p>
              ...
              <div className="bg-gray-50 p-3 rounded-lg text-sm">
                <p><strong>Total Earnings Today:</strong> ₹1200</p>
                <p><strong>Completed Deliveries:</strong> 8</p>
              </div>
